...
type ConfirmKeyTransferRequest struct {
	Sender       github_com_cosmos_cosmos_sdk_types.AccAddress             `protobuf:"bytes,1,opt,name=sender,proto3,casttype=github.com/cosmos/cosmos-sdk/types.AccAddress" json:"sender,omitempty"`
	Chain        string                                                    `protobuf:"bytes,2,opt,name=chain,proto3" json:"chain,omitempty"`
	TxID         Hash                                                      `protobuf:"bytes,3,opt,name=tx_id,json=txId,proto3,customtype=Hash" json:"tx_id"`
	TransferType KeyTransferType                                           `protobuf:"varint,4,opt,name=transfer_type,json=transferType,proto3,enum=evm.v1beta1.KeyTransferType" json:"transfer_type,omitempty"`
...
func (m *ConfirmKeyTransferRequest) Reset()         { *m = ConfirmKeyTransferRequest{} }
func (m *ConfirmKeyTransferRequest) String() string { return proto.CompactTextString(m) }
func (*ConfirmKeyTransferRequest) ProtoMessage()    {}
func (*ConfirmKeyTransferRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b4b69622c19e531, []int{6}
}
func (m *ConfirmKeyTransferRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ConfirmKeyTransferRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ConfirmKeyTransferRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ConfirmKeyTransferRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConfirmKeyTransferRequest.Merge(m, src)
}
func (m *ConfirmKeyTransferRequest) XXX_Size() int {
	return m.Size()
}
func (m *ConfirmKeyTransferRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ConfirmKeyTransferRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ConfirmKeyTransferRequest proto.InternalMessageInfo

type ConfirmKeyTransferResponse struct {
}

func (m *ConfirmKeyTransferResponse) Reset()         { *m = ConfirmKeyTransferResponse{} }
func (m *ConfirmKeyTransferResponse) String() string { return proto.CompactTextString(m) }
func (*ConfirmKeyTransferResponse) ProtoMessage()    {}
func (*ConfirmKeyTransferResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b4b69622c19e531, []int{7}
}
func (m *ConfirmKeyTransferResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ConfirmKeyTransferResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ConfirmKeyTransferResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ConfirmKeyTransferResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConfirmKeyTransferResponse.Merge(m, src)
}
func (m *ConfirmKeyTransferResponse) XXX_Size() int {
	return m.Size()
}
func (m *ConfirmKeyTransferResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ConfirmKeyTransferResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ConfirmKeyTransferResponse proto.InternalMessageInfo
...
type VoteConfirmKeyTransferRequest struct {
	Sender       github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,1,opt,name=sender,proto3,casttype=github.com/cosmos/cosmos-sdk/types.AccAddress" json:"sender,omitempty"`
	Chain        string                                        `protobuf:"bytes,2,opt,name=chain,proto3" json:"chain,omitempty"`
	PollKey      exported.PollKey                              `protobuf:"bytes,3,opt,name=poll_key,json=pollKey,proto3" json:"poll_key"`
	TxID         Hash                                          `protobuf:"bytes,4,opt,name=tx_id,json=txId,proto3,customtype=Hash" json:"tx_id"`
	TransferType KeyTransferType                               `protobuf:"varint,5,opt,name=transfer_type,json=transferType,proto3,enum=evm.v1beta1.KeyTransferType" json:"transfer_type,omitempty"`
...
func (m *VoteConfirmKeyTransferRequest) Reset()         { *m = VoteConfirmKeyTransferRequest{} }
func (m *VoteConfirmKeyTransferRequest) String() string { return proto.CompactTextString(m) }
func (*VoteConfirmKeyTransferRequest) ProtoMessage()    {}
func (*VoteConfirmKeyTransferRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b4b69622c19e531, []int{24}
}
func (m *VoteConfirmKeyTransferRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VoteConfirmKeyTransferRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VoteConfirmKeyTransferRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VoteConfirmKeyTransferRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VoteConfirmKeyTransferRequest.Merge(m, src)
}
func (m *VoteConfirmKeyTransferRequest) XXX_Size() int {
	return m.Size()
}
func (m *VoteConfirmKeyTransferRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_VoteConfirmKeyTransferRequest.DiscardUnknown(m)
}

var xxx_messageInfo_VoteConfirmKeyTransferRequest proto.InternalMessageInfo

type VoteConfirmKeyTransferResponse struct {
	Log string `protobuf:"bytes,1,opt,name=log,proto3" json:"log,omitempty"`
}

func (m *VoteConfirmKeyTransferResponse) Reset()         { *m = VoteConfirmKeyTransferResponse{} }
func (m *VoteConfirmKeyTransferResponse) String() string { return proto.CompactTextString(m) }
func (*VoteConfirmKeyTransferResponse) ProtoMessage()    {}
func (*VoteConfirmKeyTransferResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b4b69622c19e531, []int{25}
}
func (m *VoteConfirmKeyTransferResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VoteConfirmKeyTransferResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VoteConfirmKeyTransferResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VoteConfirmKeyTransferResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VoteConfirmKeyTransferResponse.Merge(m, src)
}
func (m *VoteConfirmKeyTransferResponse) XXX_Size() int {
	return m.Size()
}
func (m *VoteConfirmKeyTransferResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_VoteConfirmKeyTransferResponse.DiscardUnknown(m)
}

var xxx_messageInfo_VoteConfirmKeyTransferResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*ConfirmKeyTransferRequest)(nil), "evm.v1beta1.ConfirmKeyTransferRequest")
	proto.RegisterType((*ConfirmKeyTransferResponse)(nil), "evm.v1beta1.ConfirmKeyTransferResponse")
	...
	proto.RegisterType((*VoteConfirmKeyTransferRequest)(nil), "evm.v1beta1.VoteConfirmKeyTransferRequest")
	proto.RegisterType((*VoteConfirmKeyTransferResponse)(nil), "evm.v1beta1.VoteConfirmKeyTransferResponse")
...
var fileDescriptor_0b4b69622c19e531 = []byte{
	...
	,
}
...
func (m *ConfirmKeyTransferRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ConfirmKeyTransferRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ConfirmKeyTransferRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ConfirmKeyTransferResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ConfirmKeyTransferResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ConfirmKeyTransferResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VoteConfirmKeyTransferRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VoteConfirmKeyTransferRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VoteConfirmKeyTransferRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VoteConfirmKeyTransferResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VoteConfirmKeyTransferResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VoteConfirmKeyTransferResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ConfirmKeyTransferRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ConfirmKeyTransferResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VoteConfirmKeyTransferRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VoteConfirmKeyTransferResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ConfirmKeyTransferRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConfirmKeyTransferRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConfirmKeyTransferRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TransferType |= KeyTransferType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ConfirmKeyTransferResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConfirmKeyTransferResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConfirmKeyTransferResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *VoteConfirmKeyTransferRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VoteConfirmKeyTransferRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VoteConfirmKeyTransferRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *VoteConfirmKeyTransferResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VoteConfirmKeyTransferResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VoteConfirmKeyTransferResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
