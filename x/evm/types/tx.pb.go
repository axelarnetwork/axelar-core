...
type VoteConfirmGatewayTxRequest_Vote struct {
	Events []VoteConfirmGatewayTxRequest_Vote_Event `protobuf:"bytes,1,rep,name=events,proto3" json:"events"`
}
...
type VoteConfirmGatewayTxRequest_Vote_Event struct {
	Info EventInfo `protobuf:"bytes,1,opt,name=info,proto3" json:"info"`
	// Types that are valid to be assigned to Event:
	//	*VoteConfirmGatewayTxRequest_Vote_Event_ContractCallWithToken
	Event isVoteConfirmGatewayTxRequest_Vote_Event_Event `protobuf_oneof:"event"`
}

func (m *VoteConfirmGatewayTxRequest_Vote_Event) Reset() {
	*m = VoteConfirmGatewayTxRequest_Vote_Event{}
}
func (m *VoteConfirmGatewayTxRequest_Vote_Event) String() string { return proto.CompactTextString(m) }
func (*VoteConfirmGatewayTxRequest_Vote_Event) ProtoMessage()    {}
func (*VoteConfirmGatewayTxRequest_Vote_Event) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b4b69622c19e531, []int{4, 0, 0}
}
func (m *VoteConfirmGatewayTxRequest_Vote_Event) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VoteConfirmGatewayTxRequest_Vote_Event) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VoteConfirmGatewayTxRequest_Vote_Event.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VoteConfirmGatewayTxRequest_Vote_Event) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VoteConfirmGatewayTxRequest_Vote_Event.Merge(m, src)
}
func (m *VoteConfirmGatewayTxRequest_Vote_Event) XXX_Size() int {
	return m.Size()
}
func (m *VoteConfirmGatewayTxRequest_Vote_Event) XXX_DiscardUnknown() {
	xxx_messageInfo_VoteConfirmGatewayTxRequest_Vote_Event.DiscardUnknown(m)
}

var xxx_messageInfo_VoteConfirmGatewayTxRequest_Vote_Event proto.InternalMessageInfo

type isVoteConfirmGatewayTxRequest_Vote_Event_Event interface {
	isVoteConfirmGatewayTxRequest_Vote_Event_Event()
	MarshalTo([]byte) (int, error)
	Size() int
}

type VoteConfirmGatewayTxRequest_Vote_Event_ContractCallWithToken struct {
	ContractCallWithToken *EventContractCallWithToken `protobuf:"bytes,2,opt,name=contract_call_with_token,json=contractCallWithToken,proto3,oneof" json:"contract_call_with_token,omitempty"`
}

func (*VoteConfirmGatewayTxRequest_Vote_Event_ContractCallWithToken) isVoteConfirmGatewayTxRequest_Vote_Event_Event() {
}

func (m *VoteConfirmGatewayTxRequest_Vote_Event) GetEvent() isVoteConfirmGatewayTxRequest_Vote_Event_Event {
	if m != nil {
		return m.Event
	}
	return nil
...
func (m *VoteConfirmGatewayTxRequest_Vote_Event) GetContractCallWithToken() *EventContractCallWithToken {
	if x, ok := m.GetEvent().(*VoteConfirmGatewayTxRequest_Vote_Event_ContractCallWithToken); ok {
...
func (*VoteConfirmGatewayTxRequest_Vote_Event) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*VoteConfirmGatewayTxRequest_Vote_Event_ContractCallWithToken)(nil),
	}
}
...
type CreateApproveContractCallsRequest struct {
	Sender github_com_cosmos_cosmos_sdk_types.AccAddress `protobuf:"bytes,1,opt,name=sender,proto3,casttype=github.com/cosmos/cosmos-sdk/types.AccAddress" json:"sender,omitempty"`
	Chain  string                                        `protobuf:"bytes,2,opt,name=chain,proto3" json:"chain,omitempty"`
}

func (m *CreateApproveContractCallsRequest) Reset()         { *m = CreateApproveContractCallsRequest{} }
func (m *CreateApproveContractCallsRequest) String() string { return proto.CompactTextString(m) }
func (*CreateApproveContractCallsRequest) ProtoMessage()    {}
func (*CreateApproveContractCallsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b4b69622c19e531, []int{6}
}
func (m *CreateApproveContractCallsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CreateApproveContractCallsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CreateApproveContractCallsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CreateApproveContractCallsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreateApproveContractCallsRequest.Merge(m, src)
}
func (m *CreateApproveContractCallsRequest) XXX_Size() int {
	return m.Size()
}
func (m *CreateApproveContractCallsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_CreateApproveContractCallsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_CreateApproveContractCallsRequest proto.InternalMessageInfo

type CreateApproveContractCallsResponse struct {
}

func (m *CreateApproveContractCallsResponse) Reset()         { *m = CreateApproveContractCallsResponse{} }
func (m *CreateApproveContractCallsResponse) String() string { return proto.CompactTextString(m) }
func (*CreateApproveContractCallsResponse) ProtoMessage()    {}
func (*CreateApproveContractCallsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b4b69622c19e531, []int{7}
}
func (m *CreateApproveContractCallsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CreateApproveContractCallsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CreateApproveContractCallsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CreateApproveContractCallsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CreateApproveContractCallsResponse.Merge(m, src)
}
func (m *CreateApproveContractCallsResponse) XXX_Size() int {
	return m.Size()
}
func (m *CreateApproveContractCallsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_CreateApproveContractCallsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_CreateApproveContractCallsResponse proto.InternalMessageInfo
...
func (*AddChainRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b4b69622c19e531, []int{38}
}
...
func (*AddChainResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b4b69622c19e531, []int{39}
}
...
func init() {
	...
	proto.RegisterType((*VoteConfirmGatewayTxRequest_Vote_Event)(nil), "evm.v1beta1.VoteConfirmGatewayTxRequest.Vote.Event")
	proto.RegisterType((*VoteConfirmGatewayTxResponse)(nil), "evm.v1beta1.VoteConfirmGatewayTxResponse")
	proto.RegisterType((*CreateApproveContractCallsRequest)(nil), "evm.v1beta1.CreateApproveContractCallsRequest")
	proto.RegisterType((*CreateApproveContractCallsResponse)(nil), "evm.v1beta1.CreateApproveContractCallsResponse")
...
var fileDescriptor_0b4b69622c19e531 = []byte{
	...
	,
}
...
func (m *VoteConfirmGatewayTxRequest_Vote_Event) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VoteConfirmGatewayTxRequest_Vote_Event) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VoteConfirmGatewayTxRequest_Vote_Event) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VoteConfirmGatewayTxRequest_Vote_Event_ContractCallWithToken) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VoteConfirmGatewayTxRequest_Vote_Event_ContractCallWithToken) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *CreateApproveContractCallsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CreateApproveContractCallsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateApproveContractCallsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CreateApproveContractCallsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CreateApproveContractCallsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreateApproveContractCallsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VoteConfirmGatewayTxRequest_Vote_Event) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VoteConfirmGatewayTxRequest_Vote_Event_ContractCallWithToken) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateApproveContractCallsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CreateApproveContractCallsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VoteConfirmGatewayTxRequest_Vote) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Events = append(m.Events, VoteConfirmGatewayTxRequest_Vote_Event{})
...
func (m *VoteConfirmGatewayTxRequest_Vote_Event) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			m.Event = &VoteConfirmGatewayTxRequest_Vote_Event_ContractCallWithToken{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
...
func (m *CreateApproveContractCallsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CreateApproveContractCallsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CreateApproveContractCallsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CreateApproveContractCallsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CreateApproveContractCallsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CreateApproveContractCallsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
