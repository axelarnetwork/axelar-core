...
type ConfirmDepositRequest struct {
	...
	LabelInfo     *LabelInfo                                                      `protobuf:"bytes,6,opt,name=label_info,json=labelInfo,proto3" json:"label_info,omitempty"`
}
...
type LabelInfo struct {
	Label            github_com_axelarnetwork_axelar_core_x_nexus_exported.LabelName `protobuf:"bytes,1,opt,name=label,proto3,casttype=github.com/axelarnetwork/axelar-core/x/nexus/exported.LabelName" json:"label,omitempty"`
	RecipientAddress Address                                                         `protobuf:"bytes,2,opt,name=recipient_address,json=recipientAddress,proto3,customtype=Address" json:"recipient_address"`
...
type LinkRequest struct {
	...
	Label          github_com_axelarnetwork_axelar_core_x_nexus_exported.LabelName `protobuf:"bytes,6,opt,name=label,proto3,casttype=github.com/axelarnetwork/axelar-core/x/nexus/exported.LabelName" json:"label,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*LabelInfo)(nil), "axelar.evm.v1beta1.LabelInfo")
...
var fileDescriptor_43a3259b9722fdab = []byte{
	...
	,
}
...
func (m *ConfirmDepositRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LabelInfo != nil {
		{
			size, err := m.LabelInfo.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *LabelInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	{
		size := m.RecipientAddress.Size()
		i -= size
		if _, err := m.RecipientAddress.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintTx(dAtA, i, uint64(size))
	}
...
func (m *ConfirmDepositRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.LabelInfo == nil {
				m.LabelInfo = &LabelInfo{}
			}
			if err := m.LabelInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *LabelInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Label = github_com_axelarnetwork_axelar_core_x_nexus_exported.LabelName(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
