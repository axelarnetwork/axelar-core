...
// Deprecated in v0.22: use ConfirmGatewayTxsRequest instead
//
...
// Deprecated in v0.22: use ConfirmGatewayTxsResponse instead
//
// Deprecated: Do not use.
...
type CreateDeployTokenRequest struct {
	...
	// Deprecated in v1.4: daily mint limit is no longer enforced. This field is
	// ignored and all tokens are deployed with unlimited minting.
	DailyMintLimit string `protobuf:"bytes,7,opt,name=daily_mint_limit,json=dailyMintLimit,proto3" json:"daily_mint_limit,omitempty"` // Deprecated: Do not use.
...
// Deprecated in v1.4: CreatePendingTransfersRequest is no longer used.
// The link-deposit protocol has been removed.
//
// Deprecated: Do not use.
...
// Deprecated in v1.4: CreatePendingTransfersResponse is no longer used.
//
// Deprecated: Do not use.
...
var fileDescriptor_43a3259b9722fdab = []byte{
	...
	,
}
