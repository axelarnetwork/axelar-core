...
var (
	...
	pattern_MsgService_ConfirmToken_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"axelar", "evm", "confirm-erc20-deploy", "symbol"}, "", runtime.AssumeColonVerbOpt(true)))
