...
type TokenDetailsRequest struct {
	...
	//	*TokenDetailsRequest_Asset
	//	*TokenDetailsRequest_Symbol
	FindBy isTokenDetailsRequest_FindBy `protobuf_oneof:"find_by"`
}

func (m *TokenDetailsRequest) Reset()         { *m = TokenDetailsRequest{} }
func (m *TokenDetailsRequest) String() string { return proto.CompactTextString(m) }
...
func (m *TokenDetailsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TokenDetailsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TokenDetailsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TokenDetailsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TokenDetailsRequest.Merge(m, src)
}
func (m *TokenDetailsRequest) XXX_Size() int {
	return m.Size()
}
func (m *TokenDetailsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_TokenDetailsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_TokenDetailsRequest proto.InternalMessageInfo

type isTokenDetailsRequest_FindBy interface {
	isTokenDetailsRequest_FindBy()
	MarshalTo([]byte) (int, error)
	Size() int
}

type TokenDetailsRequest_Asset struct {
	Asset string `protobuf:"bytes,2,opt,name=asset,proto3,oneof" json:"asset,omitempty"`
}
type TokenDetailsRequest_Symbol struct {
	Symbol string `protobuf:"bytes,3,opt,name=symbol,proto3,oneof" json:"symbol,omitempty"`
}

func (*TokenDetailsRequest_Asset) isTokenDetailsRequest_FindBy()  {}
func (*TokenDetailsRequest_Symbol) isTokenDetailsRequest_FindBy() {}

func (m *TokenDetailsRequest) GetFindBy() isTokenDetailsRequest_FindBy {
	if m != nil {
		return m.FindBy
	}
	return nil
...
func (m *TokenDetailsRequest) GetAsset() string {
	if x, ok := m.GetFindBy().(*TokenDetailsRequest_Asset); ok {
		return x.Asset
	}
	return ""
}

func (m *TokenDetailsRequest) GetSymbol() string {
	if x, ok := m.GetFindBy().(*TokenDetailsRequest_Symbol); ok {
		return x.Symbol
	}
	return ""
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*TokenDetailsRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*TokenDetailsRequest_Asset)(nil),
		(*TokenDetailsRequest_Symbol)(nil),
	}
}

type TokenDetailsResponse struct {
	Details TokenDetails `protobuf:"bytes,1,opt,name=details,proto3" json:"details"`
}

func (m *TokenDetailsResponse) Reset()         { *m = TokenDetailsResponse{} }
func (m *TokenDetailsResponse) String() string { return proto.CompactTextString(m) }
...
func (m *TokenDetailsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TokenDetailsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TokenDetailsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TokenDetailsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TokenDetailsResponse.Merge(m, src)
}
func (m *TokenDetailsResponse) XXX_Size() int {
	return m.Size()
}
func (m *TokenDetailsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_TokenDetailsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_TokenDetailsResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*TokenDetailsRequest)(nil), "axelar.evm.v1beta1.TokenDetailsRequest")
	proto.RegisterType((*TokenDetailsResponse)(nil), "axelar.evm.v1beta1.TokenDetailsResponse")
}
...
var fileDescriptor_8fa0caa3a44d5acb = []byte{
	...
	,
}
...
func (m *TokenDetailsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TokenDetailsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TokenDetailsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TokenDetailsRequest_Asset) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TokenDetailsRequest_Asset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Asset)
	copy(dAtA[i:], m.Asset)
	i = encodeVarintQuery(dAtA, i, uint64(len(m.Asset)))
...
func (m *TokenDetailsRequest_Symbol) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TokenDetailsRequest_Symbol) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Symbol)
...
func (m *TokenDetailsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TokenDetailsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TokenDetailsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TokenDetailsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TokenDetailsRequest_Asset) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TokenDetailsRequest_Symbol) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TokenDetailsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TokenDetailsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TokenDetailsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TokenDetailsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.FindBy = &TokenDetailsRequest_Asset{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.FindBy = &TokenDetailsRequest_Symbol{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQuery(dAtA[iNdEx:])
...
func (m *TokenDetailsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TokenDetailsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TokenDetailsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
