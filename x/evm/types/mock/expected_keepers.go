...
// 			},
// 			GetERC20TokenByAddressFunc: func(ctx github_com_cosmos_cosmos_sdk_types.Context, address evmtypes.Address) evmtypes.ERC20Token {
...
func (mock *ChainKeeperMock) GetERC20TokenByAddress(ctx github_com_cosmos_cosmos_sdk_types.Context, address evmtypes.Address) evmtypes.ERC20Token {
