...
func NewConfirmDepositRequest(sender sdk.AccAddress, chain string, txID common.Hash, burnerAddr common.Address, recipientChain string, recipientAddr common.Address) *ConfirmDepositRequest {
	return &ConfirmDepositRequest{
		...
		RecipientAddr:  Address(recipientAddr),
	}
}
