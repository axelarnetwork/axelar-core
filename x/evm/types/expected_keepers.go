...
type EVMKeeper interface {
	...
	SetPendingSignCommand(ctx sdk.Context, commandIDHex string, pending *PendingSignCommand)
	GetPendingSignCommand(ctx sdk.Context, commandIDHex string) (PendingSignCommand, bool)
