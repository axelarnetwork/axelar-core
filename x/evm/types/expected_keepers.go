...
type EVMKeeper interface {
	...
	SetPendingSignCommand(ctx sdk.Context, chain string, commandIDHex string, axelarGatewayCommand string)
	GetPendingSignCommand(ctx sdk.Context, chain string, commandIDHex string) (string, bool)
	DeletePendingSignCommand(ctx sdk.Context, commandIDHex string)
