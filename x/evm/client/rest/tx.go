...
const (
	...
	QueryBurnerAddress        = keeper.QBurnerAddress
)
...
func RegisterRoutes(cliCtx client.Context, r *mux.Router) {
	...
	registerQuery(GetHandlerQueryBurnerAddress(cliCtx), QueryBurnerAddress, clientUtils.PathVarChain, clientUtils.PathVarRecipientChain, clientUtils.PathVarLinkedAddress)
}
