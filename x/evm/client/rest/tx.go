...
func RegisterRoutes(cliCtx client.Context, r *mux.Router) {
	...
	registerQuery(GetHandlerQueryDepositAddresses(cliCtx), QueryDepositAddresses, clientUtils.PathVarChain, clientUtils.PathVarRecipientChain, clientUtils.PathVarLinkedAddress)
}
