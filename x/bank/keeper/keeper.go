...
func (k BankKeeper) SendCoins(ctx context.Context, fromAddr sdk.AccAddress, toAddr sdk.AccAddress, amt sdk.Coins) error {
	if k.BlockedAddr(fromAddr) {
		return errorsmod.Wrapf(sdkerrors.ErrUnauthorized, "%s is not allowed to send funds", fromAddr.String())
	}
...
func (k BankKeeper) SpendableBalance(ctx context.Context, address sdk.AccAddress, denom string) sdk.Coin {
