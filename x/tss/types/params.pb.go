...
type Params struct {
	...
	// JailPeriodBlockNumberSignMaliciousCrime defines the number of blocks a
	// validator is disallowed to participate in any TSS ceremony after committing
	// a malicious crime during signing
	JailPeriodBlockNumberSignMaliciousCrime int64 `protobuf:"varint,6,opt,name=jail_period_block_number_sign_malicious_crime,json=jailPeriodBlockNumberSignMaliciousCrime,proto3" json:"jail_period_block_number_sign_malicious_crime,omitempty"`
}
...
var fileDescriptor_67c9a42e8b26dfec = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.JailPeriodBlockNumberSignMaliciousCrime != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.JailPeriodBlockNumberSignMaliciousCrime))
		i--
		dAtA[i] = 0x30
	}
	{
...
func (m *Params) Size() (n int) {
	...
	n += 1 + l + sovParams(uint64(l))
	if m.JailPeriodBlockNumberSignMaliciousCrime != 0 {
		n += 1 + sovParams(uint64(m.JailPeriodBlockNumberSignMaliciousCrime))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field JailPeriodBlockNumberSignMaliciousCrime", wireType)
			}
			m.JailPeriodBlockNumberSignMaliciousCrime = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowParams
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.JailPeriodBlockNumberSignMaliciousCrime |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
