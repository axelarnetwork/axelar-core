...
var (
	pattern_QueryService_NextKeyID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"tss", "v1beta1", "next-key-id"}, "", runtime.AssumeColonVerbOpt(true)))
)
