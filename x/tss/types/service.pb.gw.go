...
var (
	pattern_QueryService_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"axelar", "tss", "v1beta1", "params"}, "", runtime.AssumeColonVerbOpt(true)))
)
