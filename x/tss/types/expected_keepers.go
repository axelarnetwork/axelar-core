...
type TSSKeeper interface {
	...
	SelectSignParticipants(ctx sdk.Context, snapshotter Snapshotter, sigID string, validators []snapshot.Validator) (activeShares []int64, excluded []snapshot.Validator, err error)
