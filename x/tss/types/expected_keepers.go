...
type TSSKeeper interface {
	...
	SelectSignParticipants(ctx sdk.Context, snapshotter Snapshotter, sigID string, snap snapshot.Snapshot) (activeShareCount sdk.Int, excluded []snapshot.Validator, err error)
