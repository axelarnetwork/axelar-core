...
type ConnectionRouterMessage struct {
	SenderChain      ChainName `protobuf:"bytes,1,opt,name=sender_chain,json=senderChain,proto3,casttype=ChainName" json:"sender_chain,omitempty"`
	SenderAddress    string    `protobuf:"bytes,2,opt,name=sender_address,json=senderAddress,proto3" json:"sender_address,omitempty"`
	RecipientChain   ChainName `protobuf:"bytes,3,opt,name=recipient_chain,json=recipientChain,proto3,casttype=ChainName" json:"recipient_chain,omitempty"`
...
func (m *ConnectionRouterMessage) Reset()         { *m = ConnectionRouterMessage{} }
func (m *ConnectionRouterMessage) String() string { return proto.CompactTextString(m) }
func (*ConnectionRouterMessage) ProtoMessage()    {}
func (*ConnectionRouterMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_82a7a8692925fe67, []int{7}
}
func (m *ConnectionRouterMessage) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ConnectionRouterMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ConnectionRouterMessage.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ConnectionRouterMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConnectionRouterMessage.Merge(m, src)
}
func (m *ConnectionRouterMessage) XXX_Size() int {
	return m.Size()
}
func (m *ConnectionRouterMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_ConnectionRouterMessage.DiscardUnknown(m)
}

var xxx_messageInfo_ConnectionRouterMessage proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*ConnectionRouterMessage)(nil), "axelar.nexus.exported.v1beta1.ConnectionRouterMessage")
}
...
var fileDescriptor_82a7a8692925fe67 = []byte{
	...
	,
}
...
func (m *ConnectionRouterMessage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ConnectionRouterMessage) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ConnectionRouterMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.RecipientChain) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.RecipientChain)))
		i--
		dAtA[i] = 0x1a
	}
	...
	if len(m.SenderChain) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.SenderChain)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ConnectionRouterMessage) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ConnectionRouterMessage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConnectionRouterMessage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConnectionRouterMessage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.SenderChain = ChainName(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
		...
		case 3:
			...
			m.RecipientChain = ChainName(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
