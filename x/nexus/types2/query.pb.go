...
type TransfersForChainRequest struct {
	...
	State      exported2.TransferState `protobuf:"varint,2,opt,name=state,proto3,enum=nexus.exported.v1beta1.TransferState" json:"state,omitempty"`
...
type TransfersForChainResponse struct {
	Transfers  []exported2.CrossChainTransfer `protobuf:"bytes,1,rep,name=transfers,proto3" json:"transfers"`
...
type FeeResponse struct {
	FeeInfo *exported2.FeeInfo `protobuf:"bytes,1,opt,name=fee_info,json=feeInfo,proto3" json:"fee_info,omitempty"`
}
...
var fileDescriptor_18ecb24985e280bf = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.State |= exported2.TransferState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
