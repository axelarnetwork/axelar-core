...
type Nexus interface {
	...
	AddChainMaintainer(ctx sdk.Context, chain exported.Chain, validator sdk.ValAddress)
	RemoveChainMaintainer(ctx sdk.Context, chain exported.Chain, validator sdk.ValAddress)
