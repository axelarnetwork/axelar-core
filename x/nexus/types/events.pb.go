...
type NewGeneralMessage struct {
	ID          string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	PayloadHash []byte `protobuf:"bytes,2,opt,name=payload_hash,json=payloadHash,proto3" json:"payload_hash,omitempty"`
}

func (m *NewGeneralMessage) Reset()         { *m = NewGeneralMessage{} }
func (m *NewGeneralMessage) String() string { return proto.CompactTextString(m) }
func (*NewGeneralMessage) ProtoMessage()    {}
func (*NewGeneralMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_4433ea5171b09eb9, []int{3}
}
func (m *NewGeneralMessage) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *NewGeneralMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_NewGeneralMessage.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *NewGeneralMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NewGeneralMessage.Merge(m, src)
}
func (m *NewGeneralMessage) XXX_Size() int {
	return m.Size()
}
func (m *NewGeneralMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_NewGeneralMessage.DiscardUnknown(m)
}

var xxx_messageInfo_NewGeneralMessage proto.InternalMessageInfo

func (m *NewGeneralMessage) GetID() string {
	if m != nil {
		return m.ID
	}
	return ""
...
func (m *NewGeneralMessage) GetPayloadHash() []byte {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*NewGeneralMessage)(nil), "axelar.nexus.v1beta1.NewGeneralMessage")
}
...
var fileDescriptor_4433ea5171b09eb9 = []byte{
	...
	,
}
...
func (m *NewGeneralMessage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *NewGeneralMessage) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *NewGeneralMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *NewGeneralMessage) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *NewGeneralMessage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NewGeneralMessage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NewGeneralMessage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
