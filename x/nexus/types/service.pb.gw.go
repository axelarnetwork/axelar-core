...
var (
	...
	pattern_MsgService_ActivateChain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"axelar", "nexus", "registerChainMaintainer"}, "", runtime.AssumeColonVerbOpt(true)))
