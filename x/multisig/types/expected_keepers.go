...
type Keeper interface {
	...
	GetCurrentKeyEpoch(ctx sdk.Context, chainName nexus.ChainName) (KeyEpoch, bool)
	GetKeyEpoch(ctx sdk.Context, chainName nexus.ChainName, epoch uint64) (KeyEpoch, bool)
}
