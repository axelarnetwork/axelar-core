...
type KeygenOptOut struct {
	Participant []byte `protobuf:"bytes,1,opt,name=participant,proto3" json:"participant,omitempty"`
}
...
func (m *KeygenOptOut) GetParticipant() []byte {
	if m != nil {
		return m.Participant
	}
	return nil
...
func (m *KeygenOptIn) GetParticipant() []byte {
	if m != nil {
		return m.Participant
	}
	return nil
...
var fileDescriptor_36b18b0391cba3fc = []byte{
	...
	,
}
