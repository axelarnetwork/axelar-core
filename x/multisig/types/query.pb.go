...
type KeyResponse struct {
	...
	ThresholdWeight    cosmossdk_io_math.Uint                                         `protobuf:"bytes,5,opt,name=threshold_weight,json=thresholdWeight,proto3,customtype=cosmossdk.io/math.Uint" json:"threshold_weight"`
	BondedWeight       cosmossdk_io_math.Uint                                         `protobuf:"bytes,6,opt,name=bonded_weight,json=bondedWeight,proto3,customtype=cosmossdk.io/math.Uint" json:"bonded_weight"`
...
type KeygenSessionResponse struct {
	...
	KeygenThresholdWeight  cosmossdk_io_math.Uint `protobuf:"bytes,7,opt,name=keygen_threshold_weight,json=keygenThresholdWeight,proto3,customtype=cosmossdk.io/math.Uint" json:"keygen_threshold_weight"`
	SigningThresholdWeight cosmossdk_io_math.Uint `protobuf:"bytes,8,opt,name=signing_threshold_weight,json=signingThresholdWeight,proto3,customtype=cosmossdk.io/math.Uint" json:"signing_threshold_weight"`
...
var fileDescriptor_4c5266980cca9f48 = []byte{
	...
	,
}
