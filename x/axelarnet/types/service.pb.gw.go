...
var (
	pattern_MsgService_Link_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"axelar", "cosmos", "link", "recipient_chain"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_ConfirmDeposit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"axelar", "cosmos", "confirm-deposit"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MsgService_ExecutePendingTransfers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"axelar", "cosmos", "execute-pending-transfers"}, "", runtime.AssumeColonVerbOpt(true)))
)
