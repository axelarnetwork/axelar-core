...
var (
	...
	pattern_MsgService_RegisterIBCPath_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"axelar", "axelarnet", "register_ibc_path"}, "", runtime.AssumeColonVerbOpt(true)))
