...
var (
	...
	pattern_QueryService_Chains_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"axelar", "axelarnet", "v1beta1", "chains"}, "", runtime.AssumeColonVerbOpt(true)))
