...
// OperatorByProxyRequest retrieves the operator address associated with a given proxy address
...
// ProxyByOperatorRequest retrieves the proxy address associated with a given operator address
