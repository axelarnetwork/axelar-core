...
func trackAddressHandlerFn(cliCtx context.CLIContext) http.HandlerFunc {
	return func (w http.ResponseWriter, r *http.Request) {
		...
		msg := types.NewMsgTrackAddress(fromAddr, addr, req.Rescan)
...
func trackPubKeyHandlerFn(cliCtx context.CLIContext) http.HandlerFunc {
	return func (w http.ResponseWriter, r *http.Request) {
		...
		if req.UseMasterKey {
			msg = types.NewMsgTrackPubKeyWithMasterKey(fromAddr, req.Rescan)
		} else {
			msg = types.NewMsgTrackPubKey(fromAddr, req.KeyId, req.Rescan)
		}
