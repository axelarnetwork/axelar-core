...
type QueryMasterAddressResponse struct {
	...
	MasterKeyId   string `protobuf:"bytes,2,opt,name=master_key_id,json=masterKeyId,proto3" json:"master_key_id,omitempty"`
}
...
var fileDescriptor_47f1bd927442f8a6 = []byte{
	...
	,
}
...
func (m *QueryMasterAddressResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MasterKeyId) > 0 {
		...
		i = encodeVarintQuery(dAtA, i, uint64(len(m.MasterKeyId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.MasterAddress) > 0 {
		i -= len(m.MasterAddress)
		copy(dAtA[i:], m.MasterAddress)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.MasterAddress)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *QueryMasterAddressResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MasterAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MasterAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
