...
var (
	...
	pattern_MsgService_SignPendingTransfers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"axelar", "bitcoin", "sign"}, "", runtime.AssumeColonVerbOpt(true)))
)
