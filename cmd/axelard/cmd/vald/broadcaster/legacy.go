...
func NewLegacyBroadcaster(signer legacy.SignFn, client legacy.Client, conf config.ClientConfig, pipeline types.Pipeline, logger tmLog.Logger) (*LegacyBroadcasterImpl, error) {
	if conf.ChainID == "" {
