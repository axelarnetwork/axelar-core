...
func TestMgr_ProccessDepositConfirmation(t *testing.T) {
	...
	t.Run("happy path", testutils.Func(func(t *testing.T) {
		...
		err := mgr.ProcessDepositConfirmation(0, attributes)
	...
	t.Run("missing attributes", testutils.Func(func(t *testing.T) {
		...
		for i := 0; i < len(attributes); i++ {
			...
			err := mgr.ProcessDepositConfirmation(0, wrongAttributes)
			assert.Error(t, err)
...
func TestMgr_ProccessTokenConfirmation(t *testing.T) {
	...
	t.Run("happy path", testutils.Func(func(t *testing.T) {
		...
		err := mgr.ProcessTokenConfirmation(0, attributes)
	...
	t.Run("missing attributes", testutils.Func(func(t *testing.T) {
		...
		for i := 0; i < len(attributes); i++ {
			...
			err := mgr.ProcessTokenConfirmation(0, wrongAttributes)
			assert.Error(t, err)
			assert.Len(t, broadcaster.BroadcastCalls(), 0)
		}
	}).Repeat(repeats))
