## axelarcli tx distribution withdraw-all-rewards
...
Example:
$ <appcli> tx distribution withdraw-all-rewards --from mykey

```
axelarcli tx distribution withdraw-all-rewards [flags]
```
