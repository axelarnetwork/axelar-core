...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `LatestDepositAddress` | [LatestDepositAddressRequest](#axelar.nexus.v1beta1.LatestDepositAddressRequest) | [LatestDepositAddressResponse](#axelar.nexus.v1beta1.LatestDepositAddressResponse) | LatestDepositAddress queries a deposit address by recipient | GET|/axelar/nexus/v1beta1/latest_deposit_address/{recipient_addr}/{recipient_chain}/{deposit_chain}|
