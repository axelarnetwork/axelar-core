...
- [axelar/nexus/exported/v1beta1/types.proto](#axelar/nexus/exported/v1beta1/types.proto)
    ...
    - [TransferFlow](#axelar.nexus.exported.v1beta1.TransferFlow)
...
<a name="axelar.nexus.exported.v1beta1.TransferFlow"></a>
...
| `epoch` | [uint64](#uint64) |  |  |
| `flow` | [axelar.nexus.exported.v1beta1.TransferFlow](#axelar.nexus.exported.v1beta1.TransferFlow) |  | indicates whether the tracking is for transfers outgoing |
