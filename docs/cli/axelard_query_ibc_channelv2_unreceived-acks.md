## axelard query ibc channelv2 unreceived-acks
...
```
axelard query ibc channelv2 unreceived-acks [client-id] [flags]
```

### Examples

```
axelard query ibc channelv2 unreceived-acks [client-id] --sequences=1,2,3
```
