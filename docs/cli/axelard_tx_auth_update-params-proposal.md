## axelard tx auth update-params-proposal

Submit a proposal to update auth module params. Note: the entire params must be provided.

```
axelard tx auth update-params-proposal [params] [flags]
```

### Examples

```
axelard tx auth update-params-proposal '{ "max_memo_characters": 0, "tx_sig_limit": 0, "tx_size_cost_per_byte": 0, "sig_verify_cost_ed25519": 0, "sig_verify_cost_secp256k1": 0 }'
```
