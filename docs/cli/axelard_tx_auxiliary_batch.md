<<<<<<<< HEAD:docs/cli/axelard_tx_auxiliary_batch.md
## axelard tx auxiliary batch

Execute the Batch RPC method

```
axelard tx auxiliary batch [flags]
========
...
>>>>>>>> cosmos-sdk-v0.47:docs/cli/axelard_tx_gov_draft-proposal.md
```
