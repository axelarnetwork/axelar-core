...
- [axelard tx evm confirm-gateway-deployment](axelard_tx_evm_confirm-gateway-deployment.md)	 - Confirm that the gateway contract was deploy for the given chain in the given transaction at the given address
