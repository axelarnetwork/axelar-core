...
```
axelard tx ibc client misbehaviour [clientID] [path/to/misbehaviour.json] [flags]
```

### Examples

```
axelard tx ibc client misbehaviour [clientID] [path/to/misbehaviour.json] --from node0 --home ../node0/<app>cli --chain-id $CID
```
