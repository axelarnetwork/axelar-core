## axelard tx mint update-params-proposal
...
Submit a proposal to update mint module params. Note: the entire params must be provided.
See the fields to fill in by running `axelard query mint params --output json`

```
axelard tx mint update-params-proposal [params] [flags]
```

### Examples

```
axelard tx mint update-params-proposal '{ "mint_denom": "stake", ... }'
```
...
- [axelard tx mint](axelard_tx_mint.md) - Transactions commands for the mint module
