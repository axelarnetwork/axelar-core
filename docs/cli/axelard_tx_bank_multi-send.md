<<<<<<<< HEAD:docs/cli/axelard_tx_bank_multi-send.md
## axelard tx bank multi-send
========
## axelard tx multi-sign
>>>>>>>> cosmos-sdk-v0.47:docs/cli/axelard_tx_multi-sign.md
...
```
<<<<<<<< HEAD:docs/cli/axelard_tx_bank_multi-send.md
axelard tx bank multi-send [from_key_or_address] [to_address_1 to_address_2 ...] [amount] [flags]
```

### Examples

```
axelard tx bank multi-send cosmos1... cosmos1... cosmos1... cosmos1... 10stake
========
axelard tx multi-sign [file] [name] [[signature]...] [flags]
>>>>>>>> cosmos-sdk-v0.47:docs/cli/axelard_tx_multi-sign.md
```
