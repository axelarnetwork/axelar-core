## axelard tx evm create-approve-contract-calls

Create approve contract call commands that are initiated from an EVM chain

```
axelard tx evm create-approve-contract-calls [chain] [flags]
```
