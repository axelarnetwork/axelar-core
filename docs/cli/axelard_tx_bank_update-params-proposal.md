## axelard tx bank update-params-proposal

Submit a proposal to update bank module params. Note: the entire params must be provided.

```
axelard tx bank update-params-proposal [params] [flags]
```

### Examples

```
axelard tx bank update-params-proposal '{ "default_send_enabled": true }'
```
