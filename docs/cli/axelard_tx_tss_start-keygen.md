...
```
  ...
  -h, --help                                   help for start-keygen
      ...
      --key-share-distribution-policy string   policy for distributing key shares; available options: weighted-by-stake, one-per-validator (default "weighted-by-stake")
