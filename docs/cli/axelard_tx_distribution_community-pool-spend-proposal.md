## axelard tx distribution community-pool-spend-proposal

Submit a proposal to spend from the community pool

```
axelard tx distribution community-pool-spend-proposal [recipient] [amount] [flags]
```

### Examples

```
$ axelard tx distribution community-pool-spend-proposal [recipient] 100uatom
```
