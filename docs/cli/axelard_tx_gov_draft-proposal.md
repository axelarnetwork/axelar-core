<<<<<<<< HEAD:docs/cli/axelard_tx_gov_draft-proposal.md
## axelard tx gov draft-proposal

Generate a draft proposal json file. The generated proposal json contains only one message (skeleton).

```
axelard tx gov draft-proposal [flags]
========
## axelard tx vesting create-permanent-locked-account
...
```
axelard tx vesting create-permanent-locked-account [to_address] [amount] [flags]
>>>>>>>> cosmos-sdk-v0.47:docs/cli/axelard_tx_vesting_create-permanent-locked-account.md
```
