<<<<<<<< HEAD:docs/cli/axelard_tx_vesting_create-permanent-locked-account.md
## axelard tx vesting create-permanent-locked-account
========
## axelard tx gov submit-legacy-proposal software-upgrade
>>>>>>>> cosmos-sdk-v0.47:docs/cli/axelard_tx_gov_submit-legacy-proposal_software-upgrade.md
