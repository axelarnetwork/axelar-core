## axelard query ibc channel next-sequence-send
...
```
axelard query ibc channel next-sequence-send [port-id] [channel-id] [flags]
```

### Examples

```
axelard query ibc channel next-sequence-send [port-id] [channel-id]
```
