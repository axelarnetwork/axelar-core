## axelard tx staking cancel-unbond
...
Example:
$ axelard tx staking cancel-unbond axelarvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj 100stake 2 --from mykey

```
axelard tx staking cancel-unbond [validator-addr] [amount] [creation-height] [flags]
```
