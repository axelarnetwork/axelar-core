...
```
axelard tx staking create-validator [path/to/validator.json] [flags]
```

### Examples

```
$ axelard tx staking create-validator path/to/validator.json --from keyname
...
where we can get the pubkey using "axelard tendermint show-validator"
```
