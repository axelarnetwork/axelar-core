## axelard tx wasm submit-proposal update-instantiate-config
...
```
axelard tx wasm submit-proposal update-instantiate-config [code-id:permission] --title [text] --summary [text] --authority [address] [flags]
```
