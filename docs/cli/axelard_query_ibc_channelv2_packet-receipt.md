## axelard query ibc channelv2 packet-receipt
...
```
axelard query ibc channelv2 packet-receipt [client-id] [sequence] [flags]
```

### Examples

```
axelard query ibc channelv2 packet-receipt [client-id] [sequence]
```
