## axelard tx gov submit-proposal update-instantiate-config
...
Example:
$ <appd> tx gov submit-proposal update-instantiate-config 1:nobody 2:everybody 3:axelar1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm,axelar1vx8knpllrj7n963p9ttd80w47kpacrhuts497x

```
axelard tx gov submit-proposal update-instantiate-config [code-id:permission]... [flags]
```
