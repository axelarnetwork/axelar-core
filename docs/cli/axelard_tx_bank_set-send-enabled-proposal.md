## axelard tx bank set-send-enabled-proposal

Submit a proposal to set/update/delete send enabled entries

```
axelard tx bank set-send-enabled-proposal [send_enabled] [flags]
```

### Examples

```
axelard tx bank set-send-enabled-proposal '{"denom":"stake","enabled":true}'
```
