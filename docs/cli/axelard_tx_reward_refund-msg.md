<<<<<<<< HEAD:docs/cli/axelard_tx_reward_refund-msg.md
## axelard tx reward refund-msg
========
## axelard tx wasm submit-proposal migrate-contract
>>>>>>>> cosmos-sdk-v0.47:docs/cli/axelard_tx_wasm_submit-proposal_migrate-contract.md

Execute the RefundMsg RPC method

```
<<<<<<<< HEAD:docs/cli/axelard_tx_reward_refund-msg.md
axelard tx reward refund-msg [flags]
========
axelard tx wasm submit-proposal migrate-contract [contract_addr_bech32] [new_code_id_int64] [json_encoded_migration_args] --title [text] --summary [text] --authority [address] [flags]
>>>>>>>> cosmos-sdk-v0.47:docs/cli/axelard_tx_wasm_submit-proposal_migrate-contract.md
```
