...
Example:
$ axelard tx authz revoke cosmos1skj.. /cosmos.bank.v1beta1.MsgSend --from=cosmos1skj..

```
axelard tx authz revoke [grantee] [msg-type-url] --from=[granter] [flags]
```
