## axelard tx ibc client update-client-config
...
```
axelard tx ibc client update-client-config client-id [allowed-relayer-addresses...] [flags]
```

### Examples

```
axelard tx ibc client update-client-params 08-wasm-0 cosmos123... cosmos456...
```
