...
- [axelard query distribution delegator-validators](axelard_query_distribution_delegator-validators.md) - Execute the DelegatorValidators RPC method
- [axelard query distribution delegator-withdraw-address](axelard_query_distribution_delegator-withdraw-address.md) - Execute the DelegatorWithdrawAddress RPC method
- [axelard query distribution params](axelard_query_distribution_params.md) - Query the current distribution parameters.
- [axelard query distribution rewards](axelard_query_distribution_rewards.md) - Query all distribution delegator rewards
- [axelard query distribution rewards-by-validator](axelard_query_distribution_rewards-by-validator.md) - Query all distribution delegator from a particular validator
