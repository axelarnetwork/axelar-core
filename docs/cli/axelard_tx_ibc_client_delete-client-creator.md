## axelard tx ibc client delete-client-creator

delete the client creator

```
axelard tx ibc client delete-client-creator [client-id] [flags]
```

### Examples

```
axelard tx ibc client delete-client-creator 07-tendermint-0
```
