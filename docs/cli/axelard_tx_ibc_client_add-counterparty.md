## axelard tx ibc client add-counterparty

add counterparty to client

```
axelard tx ibc client add-counterparty [client-id] [counterparty-client-id] [merkle-prefix...] [flags]
```

### Examples

```
axelard tx ibc client add-counterparty 07-tendermint-0 client-0 "aWJj" ""
```
