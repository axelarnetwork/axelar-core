## axelard tx axelarnet execute-general-message

Execute an approved general message to the destination chain

```
axelard tx axelarnet execute-general-message [chain] [message ID] [payload] [flags]
```
...
```
  ...
  -h, --help                     help for execute-general-message
