## axelard query ibc channelv2 packet-commitments
...
```
axelard query ibc channelv2 packet-commitments [client-id] [flags]
```

### Examples

```
axelard query ibc channelv2 packet-commitments [client-id]
```
