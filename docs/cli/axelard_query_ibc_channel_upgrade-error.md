## axelard query ibc channel upgrade-error
...
```
axelard query ibc channel upgrade-error [port-id] [channel-id] [flags]
```

### Examples

```
axelard query ibc channel upgrade-error [port-id] [channel-id]
```
