...
- [axelard](axelard.md)	 - Axelar App
  ...
  - [tx](axelard_tx.md)	 - Transactions subcommands
    ...
    - [bitcoin](axelard_tx_bitcoin.md)	 - bitcoin transactions subcommands
      ...
      - [create-rescue-tx \[keyID\]](axelard_tx_bitcoin_create-rescue-tx.md)	 - Create a Bitcoin transaction for rescuing the outpoints that were sent to an old key \[keyID\]
