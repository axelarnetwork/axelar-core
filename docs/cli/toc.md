...
- [axelard](axelard.md)	 - Axelar App
  ...
  - [query](axelard_query.md)	 - Querying subcommands
    ...
    - [nexus](axelard_query_nexus.md)	 - Querying commands for the nexus module
      ...
      - [transfer-epoch \[chain\] \[asset\] \[direction\]](axelard_query_nexus_transfer-epoch.md)	 - Returns the transfer epoch, i.e amount of transfers within the rate limit window, for a given chain, asset, and transfer direction
