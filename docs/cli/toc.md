...
- [axelard](axelard.md)	 - Axelar App
  ...
  - [query](axelard_query.md)	 - Querying subcommands
    ...
    - [evm](axelard_query_evm.md)	 - Querying commands for the evm module
      ...
      - [deposit-addresses \[evm chain\] \[recipient chain\] \[recipient address\]](axelard_query_evm_deposit-addresses.md)	 - Returns an evm chain deposit address for a recipient address on another blockchain
