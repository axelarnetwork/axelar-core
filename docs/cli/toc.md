...
- [axelard](axelard.md)	 - Axelar App
  ...
  - [tx](axelard_tx.md)	 - Transactions subcommands
    ...
    - [evm](axelard_tx_evm.md)	 - evm transactions subcommands
      ...
      - [confirm-transfer-ownership \[chain\] \[txID\] \[newOwnerAddr\]](axelard_tx_evm_confirm-transfer-ownership.md)	 - Confirm a transfer ownership in an EVM chain transaction
