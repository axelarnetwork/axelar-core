...
- [axelard](axelard.md)	 - Axelar App
  ...
  - [tx](axelard_tx.md)	 - Transactions subcommands
    - [axelarnet](axelard_tx_axelarnet.md)	 - axelarnet transactions subcommands
      ...
      - [execute-general-message \[chain\] \[message ID\] \[payload\]](axelard_tx_axelarnet_execute-general-message.md)	 - Execute an approved general message to the destination chain
