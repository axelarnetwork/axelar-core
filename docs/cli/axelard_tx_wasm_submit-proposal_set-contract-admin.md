## axelard tx wasm submit-proposal set-contract-admin

Submit a new admin for a contract proposal

```
axelard tx wasm submit-proposal set-contract-admin [contract_addr_bech32] [new_admin_addr_bech32] --title [text] --summary [text] --authority [address] [flags]
```
