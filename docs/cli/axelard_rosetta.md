...
```
      ...
      --enable-default-fee-suggest   enable fee suggestion
  ...
  -h, --help                         help for rosetta
      ...
      --suggest-denom string         default denom to suggest fee (default "uatom")
      --suggest-gas int              default gas for fee suggestion (default 200000)
