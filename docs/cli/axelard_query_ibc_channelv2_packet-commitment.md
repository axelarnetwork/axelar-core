## axelard query ibc channelv2 packet-commitment
...
```
axelard query ibc channelv2 packet-commitment [client-id] [sequence] [flags]
```

### Examples

```
axelard query ibc channelv2 packet-commitment [client-id] [sequence]
```
