## axelard tx slashing update-params-proposal
...
Submit a proposal to update slashing module params. Note: the entire params must be provided.
See the fields to fill in by running `axelard query slashing params --output json`

```
axelard tx slashing update-params-proposal [params] [flags]
```

### Examples

```
axelard tx slashing update-params-proposal '{ "signed_blocks_window": "100", ... }'
```
