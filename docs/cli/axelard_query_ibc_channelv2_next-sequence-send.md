## axelard query ibc channelv2 next-sequence-send
...
```
axelard query ibc channelv2 next-sequence-send [client-id] [flags]
```

### Examples

```
axelard query ibc channelv2 next-sequence-send [client-id]
```
