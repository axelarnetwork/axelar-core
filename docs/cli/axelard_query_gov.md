...
- [axelard query gov constitution](axelard_query_gov_constitution.md) - Query the current chain constitution
...
- [axelard query gov tally](axelard_query_gov_tally.md) - Query the tally of a proposal vote
- [axelard query gov vote](axelard_query_gov_vote.md) - Query details of a single vote
- [axelard query gov votes](axelard_query_gov_votes.md) - Query votes of a single proposal
