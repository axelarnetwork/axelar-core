## axelard tx wasm submit-proposal store-migrate

Submit a store and migrate wasm contract proposal

```
axelard tx wasm submit-proposal store-migrate [wasm file] [contract_addr_bech32] [json_encoded_migration_args] --title [text] --summary [text] --authority [address] [flags]
```
