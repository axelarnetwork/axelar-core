...
func TestBitmap(t *testing.T) {
	t.Run("Add, CountTrue and CountFalse", testutils.Func(func(t *testing.T) {
		...
		whenPushedWith := func(value bool, count uint64) ThenStatement {
		...
		trueCount = uint64(rand.I64Between(1, 10000))
		...
		falseCount = uint64(rand.I64Between(1, 10000))
		...
		total := uint64(rand.I64Between(1, 10000))
		trueCount = uint64(rand.I64Between(1, int64(total)))
