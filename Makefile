...
ifeq ($(WASM), true)
WASM_ENABLED := "true"
ifeq ($(IBC_WASM_HOOKS), true)
IBC_WASM_HOOKS_ENABLED := "true"
...
ldflags = "-X github.com/cosmos/cosmos-sdk/version.Name=axelar \
	...
	-X github.com/axelarnetwork/axelar-core/app.IBCWasmHooksEnabled=$(IBC_WASM_HOOKS_ENABLED) \
